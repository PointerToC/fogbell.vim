...
call <sid>hi('CursorLineNr', s:none, s:voidSteel, 'none')
call <sid>hi('Directory', s:none, s:none, 'none')
call <sid>hi('FoldColumn', s:none, s:voidSteel, 'none')
call <sid>hi('Folded', s:none, s:voidSteel, 'none')
call <sid>hi('IncSearch', s:voidSteel, s:voidGold, 'none')
call <sid>hi('LineNr', s:none, s:none, 'none')
